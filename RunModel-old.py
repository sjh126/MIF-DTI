...
from utils.contrastive_loss_torch import MaxMarginContrastiveLoss
...
def run_MIF_model(SEED, DATASET, MODEL, K_Fold, LOSS, device):
    ...
    for i_fold in range(K_Fold):
        ...
        # 新增：MaxMargin 对比损失（作用于交互嵌入）
        ContrastLoss = MaxMarginContrastiveLoss(margin=1.0, metric='euclidean')
        """Output files"""
